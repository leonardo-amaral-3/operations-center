 ...
 *
 * **Apresentacional, e só.** Não conhece sessão, escopo nem pasta: recebe mensagens e devolve
 * texto. Quem possui a sessão é a tela que o monta — hoje só o `ChatScreen`. O componente que
 * possui a própria sessão é o `Chat`, e é essa diferença que separa os dois nomes.
 *
